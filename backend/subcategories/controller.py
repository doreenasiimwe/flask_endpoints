...
def new_food_subcategory():
    ...
    new_food_subcategory = SubCategory(name=name,created_by=created_by,created_at=datetime.now()) 
...
@subcategories.route('/food_category/<int:id>', methods=['GET', 'PUT', 'DELETE'])
